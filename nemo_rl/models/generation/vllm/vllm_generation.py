...
class VllmGeneration(GenerationInterface):
    ...
    def get_lora_layers(self) -> list[dict[str, Any]]:
        ...
        futures = self.worker_group.run_all_workers_single_data("get_lora_layers")
        results = ray.get(futures)
        return results

    def get_all_layers(self) -> list[dict[str, Any]]:
        """Get all the layers from the vLLM engine."""
        futures = self.worker_group.run_all_workers_single_data("get_all_layers")
        results = ray.get(futures)
        return results

    def load_weights(self, weights) -> bool:
